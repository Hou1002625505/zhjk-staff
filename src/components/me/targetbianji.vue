    ...
    <div class="addG">
        ...
        <div class="weui-cell line">
            ...
            <div class="weui-cell__bd arrow">
            	<input  class="weui-input painput" type="number" name="" id="sell" v-model="salePerformance" :placeholder="this.targetlist[0].salePerformance"  oninput="if(value.length>9)value=value.slice(0,9)"/>
        ...
        <div class="weui-cell line">
            ...
            <div class="weui-cell__bd arrow">
            	<input  class="weui-input painput" type="number" name="" id="melting" v-model="consumePerformance" :placeholder="this.targetlist[0].consumePerformance"  oninput="if(value.length>9)value=value.slice(0,9)"/>
                   <span class="yuan">元</span> 
            </div>
        </div>
          <div class="weui-cell line">
            ...
            <div class="weui-cell__bd arrow">
            	<input  class="weui-input painput" type="number" name="" id="add" v-model="customerNumber" :placeholder="this.targetlist[0].customerNumber"  oninput="if(value.length>9)value=value.slice(0,9)"/>
          ...
          <div class="weui-cell line">
            ...
            <div class="weui-cell__bd arrow">
            	<input  class="weui-input painput" type="number" name="" id="repeated" v-model="revisitNumber" :placeholder="this.targetlist[0].revisitNumber"  oninput="if(value.length>9)value=value.slice(0,9)"/>
                   <span class="yuan">人</span> 
            </div>
        </div>
         <div class="weui-cell line">
            ...
            <div class="weui-cell__bd arrow">
            	<input  class="weui-input painput" type="number" name="" id="make" v-model="dealCustomer" :placeholder="this.targetlist[0].dealCustomer"  oninput="if(value.length>9)value=value.slice(0,9)"/>
                  <span class="yuan">人</span> 
            </div>
        </div>
        </div> 
   ...
   methods: {
    gettarget(){
         this.instance.$post('/rest/wx/employee/getEmpAimInfo',{
          ...
          this.targetlist.push(res.rows[0])
    ...
    dateData(year, month) {
        ...
        targetsave(){
                var sell = $.trim($("#sell").val())||$("#sell").attr("placeholder");
				var melting = $.trim($("#melting").val())||$("#melting").attr("placeholder");
				var add = $.trim($("#add").val())||$("#add").attr("placeholder");
				var repeated = $.trim($("#repeated").val())||$("#repeated").attr("placeholder");
				var make = $.trim($("#make").val())||$("#make").attr("placeholder");
             ...
             this.instance.$post('/rest/wx/employee/updateEmpAim',{
