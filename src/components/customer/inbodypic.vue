<template>
 <div class='maintype'>
     <div class="pic" v-show="nodata">
         <img src="../../assets/images/img_inbodydetectionboot@2x .png" />
     </div>
               ...
               <div class="inbody_feipang">
                  <div class="zhushu1">
                      ...
                      <div class="tizhi">
                          ...
                          <p><img src="../../assets/images/icon_physicalfitnesspercent@2x.png" ><span class="jinum">{{item.percent_body_fat}}</span><span class="danwei">%</span>  </p>
...
.lianjie .duibi span{font-size: 0.24rem;color:#FFFFFF;}
...
.lianjie .lishi span{font-size: 0.24rem;color:#FFFFFF;}
.jiantou{  
