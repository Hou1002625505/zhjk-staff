 ...
 <div class='container'>
   ...
   <div class="item_wrap">			
		<div class="item_list_wrap">	
			<div class="item_list" v-for="(item,index) in getcusinfoList" :key="index" @click="chadetail(index,item.detailId)">
				...
				<div class="itemDetailed">
					<span>入会时间</span>
					<span>{{filDate(item.addTime)}}</span>
				</div>
			</div>
...
<script>
 export default {
   ...
   methods: {
     getcusinfo(){
        this.instance.$post('/rest/wx/customerSpa/getCustomerSpaDetailListPage',{
            page:this.pageVal,
			rows:this.pageSize,
			param:{
				id:this.customerId
