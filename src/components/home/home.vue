        ...
        <div class="qi_home_header">
          <div class="qi_home_guang" v-for="(item,index) in todayyeji" :key="index">
            ...
            <div class="daiban" v-show="daibanflag" @click="medaiban()">
              ...
              <p>待办</p>
              <div class="daibannum" v-show="dainum1">
                <span>{{totaldai}}</span>
              </div>
            </div>
          </div>
...
export default {
  ...
  methods: {
    ...
    dainum() {
      this.instance.$post(
        "/rest/wx/records/countUntreatedRecord",
        {
          name: this.positions
        },
        res => {
...
.changyong_header .text {
  float: left;
  font-size: 0.34rem;
  color: #1d1d1d;
}
.changyong_header .add {
  float: right;
  font-size: 0.24rem;
  color: #999999;
  text-shadow: 0px 3px 20px rgba(74, 119, 176, 0.5);
}
...
.feng1 {
  ...
  width: 0.54rem;
  height: 0.54rem;
  background: url(../../assets/images/home_menu_addcustomer@2x.png) no-repeat;
...
.feng2 {
  ...
  width: 0.54rem;
  height: 0.54rem;
  background: url(../../assets/images/home_menu_achievement@2x.png) no-repeat;
  background-size: contain;
}
.feng3 {
  display: inline-block;
  width: 0.54rem;
  height: 0.54rem;
  background: url(../../assets/images/home_menu_myclient@2x.png) no-repeat;
  background-size: contain;
}
.feng4 {
  display: inline-block;
  width: 0.54rem;
  height: 0.54rem;
  background: url(../../assets/images/home_menu_experiencecard@2x.png) no-repeat;
  background-size: contain;
}
.feng5 {
  display: inline-block;
  width: 0.54rem;
  height: 0.54rem;
  background: url(../../assets/images/home_menu_evaluation@2x.png) no-repeat;
  background-size: contain;
}
...
.feng6 {
  ...
  width: 0.54rem;
  height: 0.54rem;
  background: url(../../assets/images/home_menu_substitute@2x.png) no-repeat;
  background-size: contain;
}
.feng7 {
  display: inline-block;
  width: 0.54rem;
  height: 0.54rem;
  background: url(../../assets/images/home_menu_customerreception@2x.png)
    no-repeat;
  background-size: contain;
}
.feng8 {
  ...
  width: 0.54rem;
  height: 0.54rem;
  background: url(../../assets/images/home_menu_classrecords@2x.png) no-repeat;
  background-size: contain;
}
.feng21 {
  display: inline-block;
  width: 0.54rem;
  height: 0.54rem;
  background: url(../../assets/images/home_menu_order@2x.png) no-repeat;
  background-size: contain;
}
.feng22 {
  display: inline-block;
  width: 0.54rem;
  height: 0.54rem;
  background: url(../../assets/images/home_menu_stencil@2x.png) no-repeat;
  background-size: contain;
}
.feng23 {
  display: inline-block;
  width: 0.54rem;
  height: 0.54rem;
  background: url(../../assets/images/home_menu_inbodytest@2x.png) no-repeat;
  background-size: contain;
}
.feng24 {
  display: inline-block;
  width: 0.54rem;
  height: 0.54rem;
  background: url(../../assets/images/home_menu_spafile@2x.png) no-repeat;
  background-size: contain;
}
.feng25 {
  display: inline-block;
  width: 0.54rem;
  height: 0.54rem;
  background: url(../../assets/images/home_menu_schedulecheck@2x.png) no-repeat;
  background-size: contain;
}
.feng26 {
  display: inline-block;
  width: 0.54rem;
  height: 0.54rem;
  background: url(../../assets/images/home_menu_sharecare@2x.png) no-repeat;
  background-size: contain;
}
.feng27 {
  display: inline-block;
  width: 0.54rem;
  height: 0.54rem;
  background: url(../../assets/images/home_menu_contract@2x.png) no-repeat;
  background-size: contain;
}
.feng34 {
  display: inline-block;
  width: 0.54rem;
  height: 0.54rem;
  background: url(../../assets/images/home_menu_classissued@2x.png) no-repeat;
  background-size: contain;
}
</style>
