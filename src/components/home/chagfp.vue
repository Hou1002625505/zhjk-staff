<template>
 <div class='maintype'>
    <div class="question_wrap">
     ...
     <div class="addCustomer_finish" @click="finish()" v-if="hisIndex!=1"><span>完成</span></div> 
 </div>
 ...
 export default {
   data () {
     return {
       ...
       gxId:this.$route.query.gxId,
        ...
        parid:this.$route.query.gfpid,
         fanggfp:this.$route.query.fanggfp,
          fangpar:this.$route.query.fanggfp,//0通过 1未通过
   ...
   methods: {
         ...
         this.value3=res.rows[0].joinClub
          this.value4=res.rows[0].privateCoach
           this.value5=res.rows[0].fitTimes
            ...
            this.fivearr.push(res.rows[0].requirement)
            this.sixarr.push(res.rows[0].parts)
     ...
     finish(){
        ...
        this.instance.$post('/rest/wx/reception/updGfpAndAimQuestionnaire',{
           gfpId:this.gfpid,
           way:this.value1,
