<template>
 <div class='maintype'>
    ...
    <div class="addCustomer_finish" @click="wancheng()"><span>完成</span></div>
 ...
 export default {
   ...
   methods: {
    ...
    var data={
          ...
          this.instance.$post('/rest/wx/reception/addHealthParQuestionnaire',data,res => {
        console.log(res);
         if(res.rel){
              this.parid = res.msg
            if(this.value1 == "是" || this.value2 == "是" || this.value3 == "是" || this.value4 == "是" || this.value5 == "是" || this.value6 == "是" || this.value7 == "是"){
...
border-radius:50%;position: absolute;top:-120%;text-align: center;}
