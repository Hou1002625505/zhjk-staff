...
(function() {
    function t(b) {
        ...
        m && d ? (b = Math.max.apply(null, [m.r, m.g, m.b]), m = Math.max.apply(null, [d.r, d.g, d.b]), m = Math.round(m + -.75 * (m - b)), m = {
            r: m,
            g: m,
            b: m
        }) : m ? (m = Math.max.apply(null, [m.r, m.g, m.b]), b = 1, 127 < m && (b = -1), m = Math.round(m + 96 * b), m = {
            r: m,
            g: m,
            b: m
        }) : m = {
    ...
    function k(b, a) {
        ...
        this.resizeTo = function(a) {
            ...
            else if (0 === this.x) this._length = a,
            this.y = a * c(this.y);
            else if (0 === this.y) this._length = a,
            this.x = a * c(this.x);
            else {
    ...
    function n(b, a, c, e, h) {
        this.data = b;
        this.context = a;
        if (b.length) for (var m = b.length,
        d, l, f = 0; f < m; f++) {
            d = b[f];
            l = d.x.length;
            c.call(a, d);
    ...
    function r(b, a, c, e) {
        if ("ratio" === a || "%" === a.split("")[a.length - 1]) this.eventTokens[c + ".parentresized"] = e.subscribe(c + ".parentresized",
        function(a, m, d, l) {
            return function() {
                var h = m.width();
                if (h !== d) {
                    ...
                    for (g = l.length; E < g; E++) {
                        ...
                        k = 0;
                        for (r = n.x.length; k < r; k++) A.x.push(n.x[k] * h),
                        A.y.push(n.y[k] * h);
                        u.push(A)
                    }
                    f.data = u;
    ...
    function x(b, a, c) {
        ...
        this.$controlbarUpper = $('<div style="padding:0 !important; margin:0 !important;width: 100% !important;  -ms-touch-action: none; touch-action: none;"></div>').appendTo(e);
        this.isCanvasEmulator = !1;
        a = this.canvas = this.initializeCanvas(d);
        c = $(a);
        this.$controlbarLower = $('<div style="padding:0 !important; margin:0 !important;width: 100% !important; -ms-touch-action: none; touch-action: none; position: relative;"></div>').appendTo(e);
        ...
        e = function(a) {
            var b, c, e = function(e) {
                ...
                return new g(Math.round(e.pageX + b), Math.round(e.pageY + c) + a.fatFingerCompensation)
            },
            d = new w(750,
            function() {
            ...
            this.drawMoveHandler = function(b) {
                a.settings.readOnly || (b.preventDefault(), a.dataEngine.inStroke && (a.dataEngine.addToStroke(e(b)), d.kick()))
            };
            return this
        }.call({},
        this); (function(a, b, c) {
            var e = this.canvas,
            h = $(e);
            this.isCanvasEmulator ? (h.bind("mousemove.jSignature", c), h.bind("mouseup.jSignature", a), h.bind("mousedown.jSignature", b)) : (e.ontouchstart = function(h) {
    ...
    function y(b) {
        ...
        c = a.FlashCanvas ? b.ownerDocument.parentWindow.FlashCanvas: "undefined" === typeof FlashCanvas ? void 0 : FlashCanvas;
        if (c) {
            b = c.initElement(b);
            c = 1;
            a && a.screen && a.screen.deviceXDPI && a.screen.logicalXDPI && (c = 1 * a.screen.deviceXDPI / a.screen.logicalXDPI);
            if (1 !== c) try {
    ...
    v = function(b) {
        ...
        this.subscribe = function(a, b, e) {
            this.topics[a] ? this.topics[a].push([b, e]) : this.topics[a] = [[b, e]];
            return {
                topic: a,
                callback: b
            }
        ...
        this.unsubscribe = function(a) {
            if (this.topics[a.topic]) for (var b = this.topics[a.topic], e = 0, d = b.length; e < d; e++) b[e] && b[e][0] === a.callback && b.splice(e, 1)
        }
    },
    ...
    d = function(b) {
        ...
        if (0 < a) {
            ...
            if (d.getLength() > this.lineCurveThreshold) if (1 < a) {
    ...
    x.prototype.resetCanvas = function(b, a) {
        ...
        if (e.signatureLine) {
            ...
            m || (h.shadowColor = h.strokeStyle, h.shadowOffsetX = .5 * h.lineWidth, h.shadowOffsetY = -.6 * h.lineWidth, h.shadowBlur = 0)
        }
    ...
    x.prototype.initializeCanvas = function(b) {
        ...
        function a(a, b, c) {
            ...
            d.onload = function() {
                ...
                a.drawImage(d, 0, 0, d.width < e.width ? d.width: e.width, d.height < e.height ? d.height: e.height);
                a.shadowColor = b
            };
            d.src = "data:" + b + "," + a
        }
        ...
        function d(a, b) {
            ...
            if (l.hasOwnProperty(b)) 0 !== c.length && l[b].call(c[0], a, b,
            function(a) {
                return function() {
        ...
        k = function(a) {
            var b = !1;
            for (a = a.parentNode; a && !b;) b = a.body,
            a = a.parentNode;
            return ! b
        },
        p = {
        ...
        n = {
            ...
            destroy: function() {
                return this.each(function() {
                    if (!k(this)) {
                        ...
                        a && (a.$controlbarLower.remove(), a.$controlbarUpper.remove(), $(a.canvas).remove())
                    }
                })
            },
            ...
            getData: function(a) {
                ...
                void 0 === a && (a = "default");
                if (0 !== b.length && g.hasOwnProperty(a)) return g[a].call(b.get(0), b.data("jSignature.data"), b.data("jSignature.settings"))
            },
            importData: d,
            setData: d,
        ...
        $.fn.jSignature = function(a) {
            if (a && "object" !== typeof a) {
                if ("string" === typeof a && n[a]) return n[a].apply(this, Array.prototype.slice.call(arguments, 1));
    ...
    function t(k, g, n) {
        k = k.call(this); (function(g, k, n) {
            g.events.subscribe(n + ".change",
            function() {
                g.dataEngine.data.length ? k.show() : k.hide()
            })
        })(this, k, g); (function(g, k, n) {
            var r = n + ".undo";
            k.bind("click",
            function() {
                g.events.publish(r)
            });
            g.events.subscribe(r,
            function() {
        ...
        function() {
            if (this.settings[k]) {
                ...
                "function" !== typeof g && (g = function() {
                    var g = $('<input type="button" value="撤销最后一笔" style="position:absolute;display:none;margin:0 !important;top:auto;right:999px;" />').appendTo(this.$controlbarLower),
                    k = g.width();
    ...
    for (var t = {},
    k = {},
    g = "0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWX".split(""), n = g.length / 2, r = n - 1; - 1 < r; r--) t[g[r]] = g[r + n],
    k[g[r + n]] = g[r];
    var x = function(d) {
        d = d.split("");
        for (var b = d.length,
    ...
    y = function(d) {
        for (var b = [], a = 0, c = 1, e = d.length, h, f, g = 0; g < e; g++) h = Math.round(d[g]),
        f = h - a,
        a = h,
        0 > f && 0 < c ? (c = -1, b.push("Z")) : 0 < f && 0 > c && (c = 1, b.push("Y")),
        h = Math.abs(f),
    ...
    w = function(d) {
        ...
        for (var a = d.length,
        c, e = 1,
        f = [], m = 0, g = 0; g < a; g++) c = d[g],
        c in t || "Z" === c || "Y" === c ? (0 !== f.length && (f = parseInt(f.join(""), n) * e + m, b.push(f), m = f), "Z" === c ? (e = -1, f = []) : "Y" === c ? (e = 1, f = []) : f = [c]) : f.push(k[c]);
        b.push(parseInt(f.join(""), n) * e + m);
        return b
    },
    v = function(d) {
        for (var b = [], a = d.length, c, e = 0; e < a; e++) c = d[e],
        b.push(y(c.x)),
        b.push(y(c.y));
        return b.join("_")
    },
    ...
    f = function(d, b, a) {
        "string" === typeof d && ("image/jsignature;base30" === d.substring(0, 23).toLowerCase() && (d = d.substring(24)), a(z(d)))
    };
    if (null == this.jQuery) throw Error("We need jQuery for some of the functionality. jQuery is not detected. Failing to initialize..."); (function(d) {
        d = d.fn.jSignature;
    ...
    function n(f, d, b) {
        ...
        return a.getLength() > b ? (b = 2 < d ? (new k(f.x[d - 3], f.y[d - 3])).getVectorToPoint(e) : new t(0, 0), f = .35 * a.getLength(), e = a.angleTo(b.reverse()), d = c.angleTo(a.reverse()), b = (new t(b.x + a.x, b.y + a.y)).resizeTo(Math.max(.05, e) * f), c = (new t(a.x + c.x, a.y + c.y)).reverse().resizeTo(Math.max(.05, d) * f), c = new t(a.x + c.x, a.y + c.y), ["c", g(b.x, 2), g(b.y, 2), g(c.x, 2), g(c.y, 2), g(a.x, 2), g(a.y, 2)]) : ["l", g(a.x, 2), g(a.y, 2)]
    }
    function r(f, d) {
        var b = f.x.length - 1,
        a = new k(f.x[b], f.y[b]),
        ...
        if (1 < b && a.getLength() > d) {
            ...
            return ["c", g(b.x, 2), g(b.y, 2), g(a.x, 2), g(a.y, 2), g(a.x, 2), g(a.y, 2)]
        }
    ...
    function y(f) {
        for (var d = [], b = [["fill", void 0, "none"], ["stroke", "color", "#000000"], ["stroke-width", "lineWidth", 2], ["stroke-linecap", void 0, "round"], ["stroke-linejoin", void 0, "round"]], a = b.length - 1; 0 <= a; a--) {
            var c = b[a][1],
            e = b[a][2];
    ...
    function w(f, d) {
        var b = ['<?xml version="1.0" encoding="UTF-8" standalone="no"?>', '<!DOCTYPE svg PUBLIC "-//W3C//DTD SVG 1.1//EN" "http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd">'],
        a,
        c = f.length,
        e,
        h = [],
        ...
        if (0 !== c) {
            for (a = 0; a < c; a++) {
                ...
                l = simplify(l, .7, !0);
                p = 0;
                for (q = l.length; p < q; p++) e.x.push(l[p].x),
                e.y.push(l[p].y);
                n.push(e);
                h = h.concat(e.x);
                g = g.concat(e.y)
        ...
        b.push('<svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="' + a.toString() + '" height="' + e.toString() + '">');
        a = 0;
        for (c = n.length; a < c; a++) e = n[a],
        b.push("<path " + y(d) + ' d="' + x(e, k, l) + '"/>');
        b.push("</svg>");
        return b.join("")
    }
    function v(f, d) {
    ...
    function z(f, d) {
        ...
        "use strict"; (typeof exports != d + "" ? exports: f).simplify = function(b, a, c) {
            a = a !== d ? a * a: 1;
            if (!c) {
                var e = b.length,
                f, g = b[0],
    ...
    if ("undefined" === typeof $) throw Error("We need jQuery for some of the functionality. jQuery is not detected. Failing to initialize..."); (function(f) {
        f = f.fn.jSignature;
